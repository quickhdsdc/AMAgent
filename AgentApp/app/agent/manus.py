...
from app.tool import CreateChatCompletion, Terminate, ToolCollection, AwaitNext, AASParser, AASExplore
...
class Manus(BrowserAgent):
    ...
    available_tools: ToolCollection = Field(
        default_factory=lambda: ToolCollection(
            AASParser(), AASExplore(), AwaitNext(), PythonExecute(), BrowserUseTool(), StrReplaceEditor(), Terminate(), CreateChatCompletion()
        )
    )
