...
TRUNCATED_MESSAGE: str = (
    "<response clipped><NOTE>Only part of the file is shown. Use `grep -n` to search and locate specific lines, then retry this tool.</NOTE>"
)
...
Custom tool for viewing, creating, editing, and undoing file changes.
"""
...
class StrReplaceEditor(BaseTool):
    ...
    parameters: dict = {
        ...
        "properties": {
            ...
            "old_str": {
                "description": "Required parameter of `str_replace` containing the string in `path` to replace.",
                "type": "string",
            },
            "new_str": {
                "description": "Optional parameter of `str_replace` containing the new string. Required parameter of `insert` command containing the string to insert.",
                "type": "string",
            },
            "insert_line": {
                "description": "Required parameter of `insert`. The `new_str` will be inserted AFTER the line `insert_line` of `path`.",
                "type": "integer",
            },
            "view_range": {
                "description": "Optional parameter of `view` when `path` points to a file. If none, the full file is shown. If provided, the file will be shown in the indicated line number range, e.g. [11, 12] will show lines 11 and 12. Indexing at 1 to start. Setting `[start_line, -1]` shows all lines from `start_line` to the end.",
                "items": {"type": "integer"},
                "type": "array",
            },
        },
